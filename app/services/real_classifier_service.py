"""Real classifier service integrating rie-ml baseline classifier.
...
from rie_ml.baseline.classifier import BaselineClassifier as MLClassifier
...
class RealClassifier(Classifier):
    """Production classifier backed by rie-ml baseline."""
